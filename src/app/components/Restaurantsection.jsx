...
const RestaurantSection = () => {
    ...
    return (
        <div className='w-full px-4 py-8 max-w-293 mx-auto'>
            <div className='flex items-center justify-between mb-6'>
                <h2 className='text-2xl font-semibold text-gray-900'>Top Restaurants in Hisar</h2>
                    ...
                    <SwiperSlide key={r.id}>
                        <div className='rounded-xl overflow-hidden border border-gray-100 shadow-sm cursor-pointer hover:shadow-md transition-shadow'>
                            ...
                            <div className='px-3 py-3'>
                                ...
                                <p className='text-sm font-normal text-gray-500'>{r.cuisine}</p>
                            </div>
                        </div>
                    </SwiperSlide>
                ))}
