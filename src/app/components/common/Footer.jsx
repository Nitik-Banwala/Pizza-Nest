            ...
            <div className='flex flex-col bg-white max-w-285 mx-auto'>
                <div className='flex flex-col lg:flex-row w-full lg:gap-0 pt-10 md:pt-20 gap-10 lg:justify-between'>
                    <div className='max-w-full lg:max-w-[558.1px] w-full'>
                        <a href='' className='text-prime-1 leading-150 text-3xl md:text-custom-4xl Poppins'>Pizza Nest</a>
                                ...
                                <ul className='flex flex-col gap-2'>
                                    {col.links.map((link) => (
                                        <li key={link}>
                                            <a
                                                href='#'
                                                className='text-sm md:text-base font-normal text-gray-700 hover:text-prime-1 transition-colors'
                                            >
                                                {link}
                                            </a>
                                        </li>
